...
pub struct TaskControlBlockInner {
    ...
    pub exit_code: i32,
    ///  the first time the task is run
...
impl TaskControlBlockInner {
    ...
    */
    ...
    pub fn add_area(&mut self, start: VirtAddr, end: VirtAddr,permission:MapPermission) {
        self.memory_set.insert_framed_area(start, end,permission);
    }
    pub fn remove_area(&mut self, start: VirtAddr) {
        self.memory_set.remove_area_with_start_vpn(start.floor());
    }
